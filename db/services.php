...
$functions = array(
    'local_ildhvp4_setgrade' => array(
        'classname' => 'local_ildhvp4_external',
        'methodname' => 'setgrade',
        'classpath' => 'local/ildhvp4/externallib.php',
...
$services = array(
    'ildhvp4_setgrade' => array(
        'functions' => array('local_ildhvp4_setgrade'),
        'restrictedusers' => 0,
        'enabled' => 1,
    )
);